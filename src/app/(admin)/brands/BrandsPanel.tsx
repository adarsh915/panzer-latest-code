...
import { deleteBrand, readBrands, type BrandPartner } from './brandStore'
      ...
      <div className={styles.card}>
        <div className={styles.cardHeader}>
          ...
          <div className={styles.headerActions}>
            <Link href="/brands/categories" className={styles.categoriesBtn}>
              <IconifyIcon icon="tabler:category" />
              Categories
            </Link>
            <Link href="/brands/create" className={styles.addBtn}>
          ...
          <table className={styles.table}>
            ...
            <tbody>
              {paginated.length > 0 ? (
                paginated.map((brand) => (
                  <tr key={brand.id}>
                    <td className={styles.tdNum}>{brand.order}</td>
                    <td>
                    ...
                    <td>
                      <div className={styles.actions}>
                        <Link href={`/brands/${brand.id}`} className={styles.btnEdit} title="View brand">
                          <IconifyIcon icon="tabler:eye" />
                        </Link>
                        <Link href={`/brands/${brand.id}/edit`} className={styles.btnEdit} title="Edit brand">
