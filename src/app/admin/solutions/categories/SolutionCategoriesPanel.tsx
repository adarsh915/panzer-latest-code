...
import tableStyles from '../SolutionsPanel.module.scss'
      ...
      <div className={styles.card} style={{ marginBottom: '1.5rem' }}>
        <div className={styles.cardHeader}>
          ...
          <div className={styles.headerActions}>
            <Link href="/admin/solutions" className={styles.secondaryBtn}>
              ...
              {paginated.length > 0 ? (
                ...
                <tr>
                  <td colSpan={6} className={tableStyles.emptyRow}>
                    ...
                    <span>No solution categories found</span>
                  </td>
                </tr>
              )}
            </tbody>
